...
| **Spread cambiario** | El banco aplica un spread del 1–3% sobre el tipo de cambio interbancario. En $10.000 USD = $100–300 USD perdidos. | 0.66% flat sobre el monto, sin spread oculto (FIX 2026-09-14: decía 0.10%, el fee subió dos veces desde entonces). |
...
| **Mínimos rentables** | Para $500 USD, una SWIFT de $40 USD + 2% spread = 12% del monto en costos. No tiene sentido para montos pequeños. | 0.66% funciona igual para $50 o $500.000. |
