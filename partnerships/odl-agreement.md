# Acuerdo de Intención de Servicio ODL
...
El acuerdo se activa automáticamente cuando se cumplan **las tres condiciones siguientes**:
...
## COMPROMISOS DEL CLIENTE (una vez activado)
...
4. **Feedback operacional:** participar en al menos una sesión mensual de retroalimentación técnica durante los primeros 3 meses, para co-mejorar el corredor.
...
1. **Fee preferencial de lanzamiento:** aplicar un fee de **0.3%** por transacción ODL (en vez del fee estándar de 0.5%) durante los primeros **[6 / 12] meses** de operación activa del Cliente.
...
3. **Onboarding dedicado:** asignar un punto de contacto directo para el proceso de integración técnica y KYB del Cliente.

4. **Transparencia de estado:** notificar al Cliente mensualmente el estado de avance del Genesis Round hasta su cierre, con cifras de TVL actualizadas.

5. **Ventana de liquidación:** garantizar liquidación de fondos en ≤ [2 horas / 24 horas] desde la instrucción de pago durante el horario bancario chileno (lunes a viernes, 9:00–17:00 hrs).
...
*Calculado sobre el volumen comprometido en cláusula anterior.
...
Este acuerdo entra en vigor en la fecha de firma y tiene una vigencia máxima de **12 meses**. Si las condiciones precedentes no se cumplen en ese plazo, el acuerdo caduca sin efecto ni penalidad.

---

## FIRMAS

Firmado en Santiago de Chile, el [___] de [_______] de 2026.
